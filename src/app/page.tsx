    ...
    <>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: '#000', color: 'var(--text-primary)', fontFamily: 'var(--font-body)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
          ...
          {/* BANNER */}
          <div className="banner-img" style={{ width: '100%', height: '350px', overflow: 'hidden', position: 'relative' }}>
            <img src="https://res.cloudinary.com/dyiumboth/image/upload/v1774389451/dark-cosmic-banner-mystical-eye-with-spi_b5CZrJ0pTVyq47XIfcsskQ_t6PgrTEsQ7KKxdVgBPnaCA_cover_iyzbgi.jpg" alt="EgoVoid" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 40%' }} />
