  ...
  return (
    <div style={{ backgroundColor: 'black', color: 'white', minHeight: '100vh', padding: '0', margin: '0' }}>
      ...
      <div style={{ width: '100%', height: '200px', overflow: 'hidden', marginBottom: '20px' }}>
        <img 
          src="https://raw.githubusercontent.com/furcifeyes/egovoid/main/photo_2025-12-24_00-17-00.jpg" 
          alt="EgoVoid Banner" 
      ...
      <div style={{ padding: '20px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '15px', marginBottom: '20px' }}>
          <img 
            src="https://raw.githubusercontent.com/furcifeyes/egovoid/main/photo_2025-12-24_00-16-57.jpg" 
            alt="EgoVoid Logo" 
